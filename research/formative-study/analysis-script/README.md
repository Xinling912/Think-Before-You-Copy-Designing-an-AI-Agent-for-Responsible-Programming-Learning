...
in the paper. No private respondent identifiers or original database export are
required.
...
```powershell
python reproduce_formative_analysis.py
```
...
The deidentified thematic-analysis workbook in `../Analysis Result` documents
the qualitative coding and theme-development process. The paper table was
typeset directly in LaTeX from that audited workbook and is therefore not
generated by this quantitative script.
